...
plt.tight_layout()
ax.plot(dates, monthlyDev, color = ('xkcd:rust'))
...
plt.ylabel("Monthly Deviation (LST) ")
plt.title("Monthly deviation of LST - Sichuan Province from 2010 to 2021")
...
plt.tight_layout()
plt.savefig("Sichuan_dev", dpi = 400)
